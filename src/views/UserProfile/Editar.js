...
const idEmpleado = cookie.load("idUsuario")
...
*/
  ...
  const validarDatos = () => {
    ...
    const passC = cookie.load('pass')
   // this.setState({nombre: nombre.value})
 ...
 // getAvatar(idEmpleado)
/*
render(){
  const {idEmpleado} = this.state
  ...
  class AvatarClass extends React.Component {
    ...
    getAvatar = async (idUsuario) => {
      try {
        ...
        //const sendUri = "http://35.222.167.128:3019/";
